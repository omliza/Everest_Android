...
public class NowPlayingApronTest extends RefactorMobileTestCase {
	...
	@Test(suiteName = "NowPlaying", testName = "Now Playing Apron - DMCA Restricted - Buy Song button", enabled = true, groups = {
			"MOBANDEVER-325:EVQAAND-278", })
	public void verifyBuySong() {Common common = new Common(driver);
		Common.log("Verifying Now Playing Apron - DMCA Restricted - Buy Song button MOBANDEVER-325");
		try {
