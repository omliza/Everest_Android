...
public class FavoritesTest extends RefactorMobileTestCase {
	private final static Logger LOGGER = Logger.getLogger(FavoritesTest.class.getName());
	...
	@Test(suiteName = "Favorites", testName = "Favorites - No Favorites Screen", description = "Favorites - No Favorites Screen", enabled = true, groups = {
			"MOBANDEVER-311" })
	public void favoritesScreen() {
		Common common = new Common(driver);
		Common.log("Validating favorite Screen MOBANDEVER-311");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().validatefavoritesScreen();
		} catch (AndriodException ex) {
			Common.errorlog("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
			Assert.fail("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
		}
	...
	@Test(suiteName = "Favorites", testName = "Favorites - Edit Mode", description = "Favorites - Edit Mode", enabled = true, groups = {
			"MOBANDEVER-307" })
	public void favoritesScreenEditMOde() {
		Common common = new Common(driver);
		Common.log("Validating Favorites - Edit Mode MOBANDEVER-307");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().FavEditButton();
		} catch (AndriodException ex) {
			Common.errorlog("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
			Assert.fail("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
		}
	...
	@Test(suiteName = "Favorites", testName = "Favorites - Edit Mode - Confirm Button", description = "Favorites - Edit Mode - Confirm Button", enabled = true, groups = {
			"MOBANDEVER-308" })
	public void favoritesEditMode() {
		Common common = new Common(driver);
		Common.log("Validating Favorites - Edit Mode - Confirm Button  MOBANDEVER-308");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
	...
	@Test(suiteName = "Favorites", testName = "Favorites - Edit Button", description = "Favorites - Edit Button", enabled = true, groups = {
			"MOBANDEVER-304" })
	public void favoriteEdit() {
		Common common = new Common(driver);
		Common.log("Validating Favorites - Edit Button MOBANDEVER=304");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().FavEditButton();
		} catch (AndriodException ex) {
	...
	@Test(suiteName = "Favorites", testName = "Favorites", description = "Favortes - Favorites List Item", enabled = true, groups = {
			"MOBANDEVER-306" })
	public void favoritesListItem() {
		Common common = new Common(driver);
		Common.log("Validating Favortes - Favorites List Item MOBANDEVER-306");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().favoritesList();
		} catch (AndriodException ex) {
			Common.errorlog("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
			Assert.fail("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
		}
	...
	@Test(suiteName = "Favorites", testName = "Favorites", description = "Favorites - Breadcrumb", enabled = true, groups = {
			"MOBANDEVER-303" })
	public void favoritesBreadCrumb() {
		Common common = new Common(driver);
		Common.log("validating Favorites - Breadcrumb MOBANDEVER-303");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().favoritesBreadcrumb();
		} catch (AndriodException ex) {
			Common.errorlog("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
			Assert.fail("Exception occured in : " + this.getClass().getSimpleName() + " : " + ex.getMessage());
		}
	...
	@Test(suiteName = "Favorites", testName = "Favorites", description = "Favorites - Favorites List", enabled = true, groups = {
			"MOBANDEVER-305" })
	public void verifyfavoritesListItem() {
		Common common = new Common(driver);
		Common.log("Validating Favorites - Favorites List MOBANDEVER-305");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
			getPageFactory().getFavorites().favoritesList();
		} catch (AndriodException ex) {
	...
	@Test(suiteName = "Favorites", testName = "Favorites", description = "Favorites - Edit Mode - Confirm Button", enabled = true, groups = {
			"MOBANDEVER-308" })
	public void verifyfavoritesConfirmButton() {
		Common common = new Common(driver);
		Common.log("Validating Favorites - Edit Mode - Confirm Button MOBANDEVER-308");
		try {
			getPageFactory().getFavorites().clickFavoriteIcon();
